...
import { MENU_JUGUETES, MENU_LENCERIA, MENU_LUBRICANTES_COSMETICA, MENU_PIJAMAS } from "@/config/config";
...
const HeaderProduct = () => {
  return (
    <>
      ...
      <ItemDropDwonHeader title={"Lubricantes y cosmética"} option={MENU_LUBRICANTES_COSMETICA} />
